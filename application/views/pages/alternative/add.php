            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('alternative/save') ?>" method="post" autocomplete="off">
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Kriteria*</label>
                                    <div class="col-sm-12 col-md-6">
                                        <input type="text" class="form-control" name="name" placeholder="Masukkan alternative" required>
