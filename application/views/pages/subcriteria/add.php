            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('subcriteria/save') ?>" method="post" autocomplete="off">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <input type="text" class="form-control" name="weight" placeholder="Masukkan bobot sub kriteria" required>
